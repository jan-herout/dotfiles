...
vim.keymap.set('n', '<leader>fo', ":Telescope jumplist<cr>", {})
		...
		sections = {
			...
			lualine_c = {
				function()
					...
					local parent_dir = vim.fn.expand('%:p:h:t')  -- Get the parent directory name
					return parent_dir .. '/' .. filename  -- Combine them
				end,
				--icon = ''  -- Optional icon
			},

...
```bash
# ikony jsou pod /usr/share/icons
notify-send "header" "text" --icon=dialog-positive          # zelená fajfka
notify-send "header" "text" --icon=dialog-error             # zelená fajfka
notify-send "header" "text" --icon=dialog-password          # zámek

...
# ORIGINAL REPO: https://github.com/andresgongora/synth-shell-prompt
# rename - synth-shell-prompt.sh => z-synth-shell-prompt.sh - because I need this to be imported as last file
